...
const VERSION = 'a94a4c6bc9';
const SHELL = ['./', 'index.html', 'app.webmanifest', 'app/icon-192.png', 'app/icon-180.png', 'app/favicon-48.png', 'css/app.css?v=f4aa26fd1f', 'config.js?v=666ce52d45', 'js/00-errors.js?v=739f456eee', 'js/01-base.js?v=7545b08983', 'js/02-dades.js?v=be34eccaea', 'js/03-pantalla.js?v=d8a997d969', 'js/04-llista.js?v=631fb27297', 'js/05-calendari.js?v=036d9263da', 'js/06-estadistiques.js?v=f979ba3876', 'js/07-gestio.js?v=bc4cf6c70f', 'js/08-tauler.js?v=503dbba6e6', 'js/09-classes.js?v=a007a75b2d', 'js/09b-classes-horari.js?v=ed30673848', 'js/09c-classes-fitxes.js?v=1c6d25a7cc', 'js/10-inici.js?v=fd7538a918', 'js/11-fitxes.js?v=aee456ec8b', 'js/12-persones.js?v=eca7e8063b', 'js/13-avisos-mobil.js?v=3b5df93931', 'js/14-eines.js?v=345d30f517', 'js/15-copies.js?v=66ca134814', 'js/16-agrupacions.js?v=08cea47090', 'js/17-rutes.js?v=8af2b87fcd', 'js/18-repertori.js?v=aaca551640', 'js/19-concerts.js?v=139ba69554', 'js/20-sortides.js?v=df7672a942', 'js/21-missatges.js?v=b8b34625db', 'js/21b-converses.js?v=866a81681f', 'js/22-secretaria.js?v=318ba1e0c4', 'js/23-accions.js?v=cee8172969', 'js/24-arrencada.js?v=6750d07db6'];
const CDN = [
