...
const VERSION = '6d053b6d29';
const SHELL = ['./', 'index.html', 'app.webmanifest', 'app/icon-192.png', 'app/icon-180.png', 'app/favicon-48.png', 'css/app.css?v=1569c337c0', 'config.js?v=666ce52d45', 'js/00-errors.js?v=739f456eee', 'js/01-base.js?v=fb0cdc31b7', 'js/02-dades.js?v=241762059a', 'js/03-pantalla.js?v=d6eb3a62a9', 'js/04-llista.js?v=9664f0b595', 'js/05-calendari.js?v=85c90ec8e4', 'js/06-estadistiques.js?v=8a73816a7e', 'js/07-gestio.js?v=d16a2db3d1', 'js/08-tauler.js?v=daac7af085', 'js/09-classes.js?v=911df1c9b6', 'js/10-inici.js?v=80bd708dd7', 'js/11-fitxes.js?v=25ff042c2a', 'js/12-persones.js?v=686bb3c9c3', 'js/13-avisos-mobil.js?v=ed3c8795b8', 'js/14-eines.js?v=b38545ccfa', 'js/15-copies.js?v=1bd680ffbf', 'js/16-agrupacions.js?v=a502c98040', 'js/17-rutes.js?v=8af2b87fcd', 'js/18-repertori.js?v=e14fe77ee2', 'js/19-concerts.js?v=5082232e7e', 'js/20-sortides.js?v=edf2105cfc', 'js/21-accions.js?v=64c9ef5294', 'js/22-arrencada.js?v=b2243638c4'];
const CDN = [
