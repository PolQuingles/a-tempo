...
const VERSION = '6c5332c876';
const SHELL = ['./', 'index.html', 'app.webmanifest', 'app/icon-192.png', 'app/icon-180.png', 'app/favicon-48.png', 'css/app.css?v=349af515be', 'config.js?v=666ce52d45', 'js/00-errors.js?v=739f456eee', 'js/01-base.js?v=e545232d3a', 'js/02-dades.js?v=daa5157a7b', 'js/03-pantalla.js?v=585f7a2e75', 'js/04-llista.js?v=9664f0b595', 'js/05-calendari.js?v=af35f417a0', 'js/06-estadistiques.js?v=8a73816a7e', 'js/07-gestio.js?v=9f8f2aae4c', 'js/08-tauler.js?v=1f0c450f21', 'js/09-classes.js?v=5b23b3562f', 'js/10-inici.js?v=e629e5ec74', 'js/11-fitxes.js?v=1f37053a93', 'js/12-persones.js?v=686bb3c9c3', 'js/13-avisos-mobil.js?v=b0501001f0', 'js/14-eines.js?v=aabdb2072f', 'js/15-copies.js?v=fd380e9298', 'js/16-agrupacions.js?v=a502c98040', 'js/17-rutes.js?v=47155d2dc4', 'js/18-accions.js?v=6617c45681', 'js/19-arrencada.js?v=4c65a93576'];
const CDN = [
